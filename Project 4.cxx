...
int main()
{
	...
	int x;
	int year;
	cout<<"WELCOME TO RICH_TECH BECE CHECKER\n"<<"Enter the five digit code on the checker card to allow access\n";
	cin>>code;
	...
	cout<<"Candidate Name: "<<firstName<<" "<< secondName<<"          Year: "<<year<<endl;
	cout<<"School:"<<schllName<<" "<< schllNamea<<"    Index Number: "<<indexNum;
	cout<<"\n";
	cout<<"\n";
	cout<<"SUBJECT            GRADE     EEXPRESSION \n";
	cout<<"\n";
